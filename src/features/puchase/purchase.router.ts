...
export class PurchaseRouter extends BaseRouter<PurchaseController, PurchaseMiddleware>{
  ...
  routes(): void {
    this.router.get('/purchase', (req,res) => this.controller.getPurchases(req,res));
    ...
    this.router.put('/purchase/:id', (req,res) => this.controller.updatePurchase(req,res));
    this.router.delete('/purchase/:id', (req,res) => this.controller.deletePurchase(req,res));
  }
};